...
import {Image,TouchableOpacity,ScrollView,StyleSheet,Text,TextInput,View,AsyncStorage} from 'react-native';
    ...
    render(){
        ...
        <CustomHeader navigation={this.props.navigation} />
                ...
                <View style={styles.container3}>
                    ...
                    <Text style={{marginLeft:12}}> 12 Conversations</Text>
                    <View style={styles.scrollContent}>
                    ...
                    <Image source={shd3} style={{marginRight: '10%', height: 20, width: 23}}/> 
